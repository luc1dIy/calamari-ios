...
namespace Offsets {
    ...
    long long xua_newthread_address = offsetLoc(0x0000000100E911F8);   
    long long xua_newthread_return = offsetLoc(0x0000000100326B48);    
    DF(
...
@class AppsFlyerUtils; @class InputCapture; 
